 ...
 * included — at the instant the mission completes. Driven straight off
 * scroll progress so it's scrubbable, and it fires the moment the sequence
 * ramps up (razor spike, gone within a breath).
 */
...
export default function ImpactFlash() {
  ...
  useScrollRaf(() => {
    ...
    // Sub-second cyan/white bloom then a fast afterglow tail
  ...
  return (
    <div
      ...
      style={{
        ...
        visibility: "hidden",
        background:
          "radial-gradient(circle at 34% 52%, #ffffff 0%, #d4f5ff 30%, #80e5ff 60%, rgba(0,212,255,0) 100%)",
        mixBlendMode: "screen",
        willChange: "opacity",
      }}
    />
